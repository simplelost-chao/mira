...
def topbar_css() -> str:
    ...
    return (
        ...
        "  }\n"
        "  .topbar-logo .logo-m { font-size: 18px; font-weight: 450; color: var(--accent); text-shadow: 0 0 10px var(--accent); }\n"
        "  .topbar-logo .logo-ira { font-size: 18px; font-weight: 450; color: var(--text); opacity: .75; }\n"
        "  .topbar-logo .logo-cursor { font-size: 18px; font-weight: 450; color: var(--accent); opacity: .9; animation: topbar-blink 1.1s step-end infinite; }\n"
